  ...
  return (
      ...
      <div>
       <div className='h-screen relative'>
         <div className='h-3/4 pt-20 bg-theme'>
            <lottie-player 
              src="https://assets4.lottiefiles.com/packages/lf20_z01bika0.json" 
         ...
         <div className='absolute left-0 right-0 -bottom-70'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#2a2a2a"  d="M0,128L48,128C96,128,192,128,288,112C384,96,480,64,576,74.7C672,85,768,139,864,176C960,213,1056,235,1152,218.7C1248,203,1344,149,1392,122.7L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
          </svg>
         </div> 
       </div>
    </div>
    <div className='mt-32 md:mt-5'>
        ...
        <div className='font-bold text-center bg-gray-500 mx-5 p-20 text-white rounded-tl-full rounded-br-full mt-5'>
          <h2 className='text-4xl md:text-xl' data-aos="slide-down"> La educación nos ayuda a ver ...</h2>

          <h2 className='text-4xl md:text-xl' data-aos="slide-up"> el significado de la vida.</h2>
       </div>
    </div>
